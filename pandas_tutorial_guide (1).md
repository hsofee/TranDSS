...
### โครงงานที่ 1: E-commerce Sales Analysis (35 คะแนน)

**เป้าหมาย**: วิเคราะห์ข้อมูลการขายของร้านค้าออนไลน์

**ข้อมูล**: สร้าง realistic e-commerce dataset หรือใช้ข้อมูลจริง
- Customer data (ID, name, age, city, registration_date)
- Product data (ID, name, category, price, cost)
- Order data (order_id, customer_id, product_id, quantity, order_date)
- Review data (order_id, rating, review_text)

**งานที่ต้องทำ**:

#### 1. Data Generation และ Loading (5 คะแนน)
```python
def generate_ecommerce_data():
    """
    สร้างข้อมูล e-commerce ที่มีความสมจริง
    
    Returns:
    dict ของ DataFrames: customers, products, orders, reviews
    """
    # TODO: สร้างข้อมูลที่สมจริง
    # - 10,000 customers
    # - 1,000 products ใน 10 categories
    # - 50,000 orders ตลอด 2 ปี
    # - Reviews สำหรับ 70% ของ orders
    pass

def load_and_validate_data(data_dict):
    """
    โหลดและตรวจสอบความถูกต้องของข้อมูล
    
    Parameters:
    data_dict: dictionary ของ DataFrames
    
    Returns:
    validated และ cleaned DataFrames
    """
    # TODO: implement data validation และ cleaning
    pass
```

#### 2. Customer Analysis (10 คะแนน)
```python
def customer_segmentation_analysis(customers, orders):
    """
...
def identify_vip_customers(customers, orders, threshold_percentile=95):
    """
    ระบุลูกค้า VIP
    
    Criteria:
    - Total spending in top 5%
    - High frequency purchases
    - Recent activity
    """
    # TODO: implement VIP identification
    pass
```

#### 3. Product Performance Analysis (10 คะแนน)
```python
def product_performance_dashboard(products, orders, reviews):
    """
    วิเคราะห์ performance ของสินค้า
...
def inventory_insights(products, orders):
    """
    insights สำหรับการจัดการสต็อก
...
#### 4. Time Series และ Forecasting (10 คะแนน)
```python
...
def simple_sales_forecast(orders, forecast_days=30):
    """
    พยากรณ์ยอดขายแบบง่าย
    ...
    - Trend analysis
    """
    # TODO: implement simple forecasting
    pass
```

### โครงงานที่ 2: Financial Portfolio Analysis (40 คะแนน)

**เป้าหมาย**: วิเคราะห์ portfolio การลงทุนและสร้าง dashboard

**ข้อมูล**: ข้อมูลราคาหุ้น, ข้อมูลเศรษฐกิจ, portfolio holdings

#### 1. Data Collection และ Processing (10 คะแนน)
```python
def collect_stock_data(symbols, start_date, end_date):
    """
    รวบรวมข้อมูลราคาหุ้น (สามารถจำลองหรือใช้ real data)
    
    Parameters:
    symbols: list ของ stock symbols
    start_date, end_date: วันที่เริ่มต้นและสิ้นสุด
    
    Returns:
    DataFrame ที่มีข้อมูลราคาหุ้น
    """
...
#### 2. Risk และ Return Analysis (15 คะแนน)
```python
def portfolio_risk_return_analysis(returns_data, weights):
    """
    วิเคราะห์ risk และ return ของ portfolio
    ...
    - Beta calculation
    """
    # TODO: implement risk-return analysis
    pass

def correlation_analysis(returns_data):
    """
    วิเคราะห์ correlation ระหว่างหุ้น
...
#### 3. Portfolio Optimization (15 คะแนน)
```python
def efficient_frontier_calculation(returns_data):
    """
    คำนวณ efficient frontier (แบบง่าย)
...
def rebalancing_analysis(current_weights, target_weights, price_data):
    """
    วิเคราะห์การ rebalance portfolio
    ...
    """
    # TODO: implement rebalancing analysis
    pass
```

### โครงงานที่ 3: Healthcare Data Analytics (35 คะแนน)

**เป้าหมาย**: วิเคราะห์ข้อมูลสุขภาพและสร้าง insights

**ข้อมูล**: Patient data, treatment data, outcome data (simulated for privacy)

#### 1. Patient Demographics Analysis (10 คะแนน)
```python
def generate_patient_data(n_patients=10000):
    """
    สร้างข้อมูลผู้ป่วยที่สมจริง (synthetic data)
    ...
    """
    # TODO: generate realistic patient data
    pass

def demographic_health_analysis(patient_data):
    """
    วิเคราะห์ health patterns ตาม demographics
...
#### 2. Treatment Effectiveness Analysis (15 คะแนน)
```python
def treatment_outcome_analysis(patient_data, treatment_data, outcome_data):
    """
    วิเคราะห์ประสิทธิภาพของการรักษา
